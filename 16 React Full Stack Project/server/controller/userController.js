...
export const userRegistrationController = async(request,response)=>{
    try {
        ...
        const mailData = `hello ${email}.This is an verification mail by Food Delivery.Please click the below link for verification <br> <a href='http://localhost:3001/user/verifyEmail?email=${email}'>click here</a>`
